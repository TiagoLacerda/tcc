...
build:
	...
	g++ -g main.cpp src/graph/graph.cpp src/disjoint_sets/disjoint_sets.cpp src/util/util.cpp -o $(OUTPUT) $(FLAGS)
...
tests: 
	...
	g++ -g src/graph/graph.test.cpp src/disjoint_sets/disjoint_sets.test.cpp src/util/util.test.cpp src/graph/graph.cpp src/disjoint_sets/disjoint_sets.cpp src/util/util.cpp include/doctest.h -o test.exe $(FLAGS)